...
urlpatterns = [
    ...
    url(r'^order/section/$', my_order.section, name='section'),
    url(r'^order/sectionlist/$', my_order.sectionlist, name='sectionlist'),
    url(r'^order/edit/(?P<student_id>\d+)/$', my_order.edit, name='edit'),
    url(r'^order/delete/(?P<student_id>\d+)/$', my_order.destroy, name='delete'),
    url(r'^products$', my_order.index_product, name='home_product'),
    url(r'^product/new/$', my_order.new_product, name='new_product'),
    url(r'^product/delete/(?P<section_id>\d+)/$', my_order.destroy_product, name='delete_product'),
